...
if(list != null) {
    ...
    const render = (products, local) => {
        if(local) {
                    ...
                    `<li class="row border-bottom border-secondary pb-4 pt-4">
                        <div class="col-12 col-md-3 col-lg-3 d-flex justify-content-center mb-3">
                            <img src="/laptop/${
                                ...
                                (product.image_names?product.image_names.split(',')[0]: 'default.jpg')
                        ...
                        <div class="col-12 col-lg-3 text-right">
                            ...
                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="display: block; margin: 5px 0; ">
                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                    ...
                                    <button class="border border-secondary btn btn-white quantity" type="button">1</button>
                                    <button data-user = "${
                                        user === null ? null : user.user_id
            ...
            list.innerHTML = html;
            let cost = products.reduce((acc, cur) => acc + parseFloat(cur.new_price), 0);
